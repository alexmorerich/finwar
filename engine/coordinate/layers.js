...
//   tax  : TAX Exposure  / TAX风险    — tax visibility / reporting (CRS is one node — see engine/tax/)
//
...
export const AXES = {
  ...
  TAX:  { key: "TAX",  en: "TAX Exposure",  zh: "TAX风险",  z: "z" },
};
...
export const SETTLEMENT_SYSTEMS = {
  US_Settlement:            { en: "US Settlement",            zh: "美国结算体系",   ofac: 95, safe:  5, tax: 70 },
  Singapore_Settlement:     { en: "Singapore Settlement",     zh: "新加坡结算体系", ofac: 30, safe: 20, tax: 75 },
  HongKong_Settlement:      { en: "Hong Kong Settlement",     zh: "香港结算体系",   ofac: 45, safe: 50, tax: 65 },
  China_Settlement:         { en: "China Settlement",         zh: "中国结算体系",   ofac: 25, safe: 95, tax: 40 },
  Decentralized_Settlement: { en: "Decentralized Settlement", zh: "去中心化结算",   ofac:  8, safe:  8, tax:  8 },
  Issuer_Crypto_Settlement: { en: "Issuer Crypto Settlement", zh: "发行方加密结算", ofac: 70, safe: 30, tax: 30 },
  Physical_Gold_Settlement: { en: "Physical Gold Settlement", zh: "实物黄金结算",   ofac:  5, safe: 10, tax: 20 },
  Real_Estate_Settlement:   { en: "Real Estate Settlement",   zh: "房地产结算",     ofac: 15, safe: 60, tax: 50 },
};

// ─────────────────── LAYER 2 · Custody Jurisdiction / 托管司法区 ───────────────────
export const CUSTODY_JURISDICTIONS = {
  US:            { en: "United States", zh: "美国",     ofac: 90, safe:  5, tax: 80 },
  Singapore:     { en: "Singapore",     zh: "新加坡",   ofac: 35, safe: 20, tax: 75 },
  HongKong:      { en: "Hong Kong",     zh: "香港",     ofac: 40, safe: 55, tax: 65 },
  ChinaMainland: { en: "China Mainland", zh: "中国大陆", ofac: 25, safe: 95, tax: 35 },
  DMCC:          { en: "Dubai DMCC",    zh: "迪拜DMCC", ofac: 30, safe: 15, tax: 45 },
  None:          { en: "No Custody",    zh: "无托管",   ofac:  5, safe:  5, tax:  8 },
};

// ─────────────────── LAYER 3 · Ownership Model / 所有权模式 ───────────────────
// Affects confiscation resistance: a self-custodied / bearer holding has no
// compellable intermediary, so it sits low on OFAC and TAX regardless of class.
export const OWNERSHIP_MODELS = {
  custodian:           { en: "Custodian",            zh: "托管模式",     ofac: 80, safe: 60, tax: 85 },
  nominee:             { en: "Nominee",              zh: "名义持有",     ofac: 90, safe: 65, tax: 90 },
  self_custody:        { en: "Self Custody",         zh: "自主保管",     ofac:  5, safe: 10, tax:  5 },
  physical_possession: { en: "Physical Possession",  zh: "实物持有",     ofac: 10, safe: 20, tax: 12 },
  bearer:              { en: "Bearer Asset",         zh: "不记名资产",   ofac: 12, safe: 15, tax:  8 },
  direct_register:     { en: "Direct Registration",  zh: "直接登记",     ofac: 50, safe: 55, tax: 70 },
};

// ─────────────────── LAYER 4 · Asset Class / 资产类别 ───────────────────
// The lowest-priority coordinate — it nudges, it never dominates.
export const ASSET_CLASSES = {
  Equity:       { en: "Equity",         zh: "股票",     ofac: 60, safe: 55, tax: 70 },
  ETF:          { en: "ETF",            zh: "ETF",      ofac: 65, safe: 55, tax: 72 },
  FixedIncome:  { en: "Fixed Income",   zh: "固定收益", ofac: 65, safe: 50, tax: 70 },
  Cash:         { en: "Cash",           zh: "现金",     ofac: 55, safe: 60, tax: 60 },
  PhysicalGold: { en: "Physical Gold",  zh: "实物黄金", ofac: 10, safe: 15, tax: 30 },
  RealEstate:   { en: "Real Estate",    zh: "房地产",   ofac: 20, safe: 70, tax: 50 },
  Crypto:       { en: "Cryptocurrency", zh: "加密货币", ofac: 15, safe: 15, tax: 10 },
  Stablecoin:   { en: "Stablecoin",     zh: "稳定币",   ofac: 70, safe: 35, tax: 25 },
  PrivateAsset: { en: "Private Asset",  zh: "私募资产", ofac: 45, safe: 55, tax: 40 },
};
...
const FALLBACK = { en: "Unknown", zh: "未知", ofac: 50, safe: 50, tax: 50 };
